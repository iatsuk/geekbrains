...
first_name, last_name, email = input('Введите имя, фамилию и почту через пробел: ').split()
print('Success') if re.match('[A-Z][a-z]+', first_name) and re.match('[A-Z][a-z]+', last_name) and re.match('[a-z\d_]+@[a-z]+\.(ru|org|com)', email) else print('Failed')
...
print('found') if re.search('[.]{2,}', some_str) else print('not found')
